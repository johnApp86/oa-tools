  ...
  <div class="tax-management">
    ...
    <div class="table-container">
      <el-table :data="tableData" v-loading="loading" stripe border>
        <el-table-column prop="tax_code" label="税务编号" width="150" />
        <el-table-column prop="tax_name" label="税种名称" width="150" />
        <el-table-column prop="tax_type" label="税种类型" width="120" />
        <el-table-column prop="taxable_amount" label="应税金额" width="120" align="right">
        ...
        <el-table-column prop="due_date" label="申报期限" width="120" />
